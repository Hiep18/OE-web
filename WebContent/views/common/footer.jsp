		...
		<div class="container-fluid tm-container-small">
			<div class="row">
				<div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
					<h3 class="tm-text-primary mb-4 tm-footer-title">Về chúng tôi</h3>
					<p>Chúng tôi cố gắng tạo ra một cộng đồng xem phim lành mạnh.
						Giúp người dùng quản lí, chia sẽ các video của mình</p>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 col-12 px-5 mb-5">
					<h3 class="tm-text-primary mb-4 tm-footer-title">Liên hệ</h3>
			...
			<div class="row">
				<div class="col-lg-8 col-md-7 col-12 px-5 mb-3">Copyright 2022
					Group 5 Company. All rights reserved.</div>
				<div class="col-lg-4 col-md-5 col-12 px-5 text-right">
					Designed by <a href="https://templatemo.com" class="tm-text-gray"
						rel="sponsored" target="_parent">Group 5</a>
				</div>
			</div>
		</div>
	</footer>
	<script src="<c:url value='/views/user/js/plugins.js'/>"></script>
	<script>
